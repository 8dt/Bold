 ...
 * @website https://github.com/SMC242/Bold
 * @source https://raw.githubusercontent.com/SMC242/Bold/master/dist/Bold.plugin.js
 */
/*@cc_on
@if (@_jscript)
...
let UwUconverter = function UwUconverter(msg_content) {
    ...
    return (kaomoji + edited_text); // add a kaomoji
};
const converters = {
    uwu: UwUconverter,
};
...
module.exports = (() => {
    const config = {
        info: {
            ...
            github: "https://github.com/SMC242/Bold",
            github_raw: "https://raw.githubusercontent.com/SMC242/Bold/master/dist/Bold.plugin.js",
        },
        changelog: [
            {
                ...
                type: "fixed",
                items: [
                    "If you put your activation string in the middle of your message, it would Bold and delete the start of your message.",
                    "This is now fixed.",
                ],
            },
            {
                ...
                type: "fixed",
                items: [
                    "Please delete `Bold.config.json` in your plug-ins folder as its format is now invalid.",
    ...
    return !global.ZeresPluginLibrary
        ...
        : (([Plugin, Api]) => {
            const Bold = (Plugin, Library) => {
                const { Logger, Patcher, Settings, DiscordModules } = Library;
                return class Bold extends Plugin {
                    constructor() {
                        var _a;
                        super();
                        this.settings = (_a = Bapi.loadData("Bold", "settings")) !== null && _a !== void 0 ? _a : default_settings;
                    }
                    getName() {
                        return config.info.name;
                    }
                    ...
                    conversion(channel, msg_info, send_status) {
                        ...
                        // check that the user intends to Bold by looking for the activation string at the start of the message
                    ...
                    async save_settings() {
                        Bapi.saveData("Bold", "settings", this.settings);
                    }
                    /**
                    ...
                    getSettingsPanel() {
                        ...
                        return Settings.SettingPanel.build(this.save_settings.bind(this), new Settings.Textbox("Activation text", "The text that you must write at the start to Bold your message", this.settings.activation_text, this.set_activation_text.bind(this)), new Settings.Dropdown("Select converter", "This is the function that will be used to convert your message", this.settings.converter_name, converters, this.set_converter.bind(this), {
                            searchable: true,
                        }));
                    }
                };
            };
            return Bold(Plugin, Api);
            // @ts-ignore
